...
public class AudioM {
    ...
    private AudioCodec.OnCompleteListener onCompleteListener;
    private AudioCodec.OnProgressListener onProgressListener;
     ...
     */
    private void dstAudioFormatFromPCM(byte[] data) {
